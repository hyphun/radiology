...
@section('content')
 <!-- start section -->
        <section class="sm-mb-50px bg-dark-gray"  data-parallax-background-ratio="0.5" style="background-image: url({{asset('assets/images/radiology_about_bg.png')}}); height:350px; background-size: contain !important;"></section>
        <!-- end section -->
        <!-- start section -->
        <section class="p-0">
            <div class="container">
